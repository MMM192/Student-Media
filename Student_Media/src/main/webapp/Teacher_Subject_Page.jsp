...
ResultSet getDoc2 = DatabaseConnection.getResultFromSqlQuery(
	    "SELECT * FROM documents WHERE Tid = '" + session.getAttribute("id") +  "' and department_name='" + request.getParameter("Corse_Name")+ "'");
...
<a id="Atagedit" href="Teacher_Title_Document.jsp?Corse_Name=<%=request.getParameter("Corse_Name")%>&Subject_Name=<%=b %>">
<div class="folder">
...
<a href="Teacher_Title_Document.jsp?Corse_Name=<%=request.getParameter("Corse_Name")%>&Subject_Name=<%=b %>">
<div class="folder">
