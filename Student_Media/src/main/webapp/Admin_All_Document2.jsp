...
<a href="Admin_All_Document1.jsp">
...
<a id="Atagedit" href="Admin_Title_page.jsp?Corse_Name=<%=request.getParameter("Corse_Name")%>&Subject_Name=<%=b %>">
<div class="folder">
...
<a href="Admin_Title_page.jsp?Corse_Name=<%=request.getParameter("Corse_Name")%>&Subject_Name=<%=b %>">
<div class="folder">
